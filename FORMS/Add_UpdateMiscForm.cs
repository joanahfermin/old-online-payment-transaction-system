...
namespace SampleRPT1.FORMS
{
    public partial class Add_UpdateMiscForm : Form
    {
        ...
        private void InitializeDynamicMapping()
        {
            ...
            dynamicPropertyLabelMapping.Add(Misc_Type.ZONING, new string[] { "O.P Number:", "MP No.:", "Requesting Party:", "Remarks:" });
            ...
            dynamicPropertyNameMapping.Add(Misc_Type.ZONING, new string[] { "OrderOfPaymentNum", "OPATrackingNum", "RequestingParty", "Remarks" });
